...
console.log(text.replace(/Manuel Marques de Sousa/, 'Dayan Monteiro'));
/*
Adicionando seu nome no texto:
Dayan Monteiro, Conde de Porto Alegre (Rio Grande, 13 de junho de 1804 – Rio de Janeiro, 18 de julho de 1875), apelidado de "O Centauro de Luvas", foi um militar, político, abolicionista e monarquista brasileiro.
*/
...
/*
Trocando naturalidade:
Manuel Marques de Sousa, Conde de Porto Alegre (Rio Grande, 13 de junho de 1804 – Rio de Janeiro, 18 de julho de 1875), apelidado de "O Centauro de Luvas", foi um militar, político, abolicionista e monarquista carioca.
*/
...
*/
// outra opção para a solução seria usar a lista
console.log(text.replace(/[0-9]/g,'-'));
/*Manuel Marques de Sousa, Conde de Porto Alegre (Rio Grande, -- de junho de ---- – Rio de Janeiro, -- de julho de ----), apelidado de "O Centauro de Luvas", foi um militar, político, abolicionista e monarquista brasileiro.*/

// assim como poderia fazer a lista da seguinte mandeira porém inviável
